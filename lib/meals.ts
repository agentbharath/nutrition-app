...
const BREAKFAST: Meal = {
  ...
  items: [
    ...
    { name: 'Pumpkin Seeds*', amount: '1 tbsp (when available)', cal: 46, protein: 2.5, sodium: 0, fiber: 0.5, carbs: 2 },
  ...
  notes: '*Add pumpkin seeds when available — +75mg magnesium, 0 sodium',
}
...
const WFH_DINNER: Meal = {
  ...
  items: [
    { name: 'Ezekiel Low Sodium Bread', brand: 'Food for Life', amount: '3 slices', cal: 240, protein: 12, sodium: 225, fiber: 9, carbs: 45 },
  ...
  totals: { cal: 768, protein: 34, sodium: 398, fiber: 23, carbs: 75 },
  notes: 'Ezekiel from Whole Foods/Sprouts frozen section. Skip PB on gym days.',
}
...
const WFH_DINNER_GYM: Meal = {
  ...
  totals: { cal: 673, protein: 30, sodium: 398, fiber: 22, carbs: 72 },
  notes: 'No peanut butter on gym days to save calories.',
}
